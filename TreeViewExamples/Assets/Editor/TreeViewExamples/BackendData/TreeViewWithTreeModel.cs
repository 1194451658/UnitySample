...
namespace UnityEditor.TreeViewExamples
{
	...
	// TreeElement: 自己定义的，树节点数据结构
	// 在TreeViewItem上，显示TreeElement数据
	...
	internal class TreeViewWithTreeModel<T> : TreeView where T : TreeElement
	{
		...
		protected override TreeViewItem BuildRoot()
		{
			...
			return new TreeViewItem<T>(
				m_TreeModel.root.id,		// id
				depthForHiddenRoot,			// depth
				m_TreeModel.root.name,		// displayName
				m_TreeModel.root			// data
			);
		}
